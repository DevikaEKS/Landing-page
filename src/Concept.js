                ...
                <div className='row no-gutters '>
                    <div className='col d-flex box2 rounded-1 part1' id='b1'>
                        ...
                        <div>
                            ...
                            <p>We empower students to take charge of their careers and develop their professional identities</p>
                        </div>
                    </div>
                    ...
                    <div className='col d-flex box2 rounded-1 part2'>
                        <div>
                            ...
                            <p>We encourage creativity and the out-of-the-box thinking,are providing opportunities that challenge and inspire.</p>
                        </div>
                ...
                <div className='row mb-5'>
                    <div className='col d-flex box2 rounded-1'>
                        ...
                        <div>
                            ...
                            <p>We are committed to maintaining the highest standards of honesty and fairness in all our interactions.</p>
                        </div>
                    </div>
                    ...
                    <div className='col d-flex box2 rounded-1' id='b1'>
                        <div>
                            ...
                            <p>We foster a supportive community where students and our professionals can collaborate and grow together.</p>
                        </div>
